                ...
                ? 
                  <>
                    <div className="navigation-wrapper">
                      <Logo />
                      <button className="navigation__burger hover-opacity-btn" onClick={burgerClick} />
                    </div>
                  </>
                : 
                  <nav className="navigation">
                    <div className="navigation-wrapper">
                      ...
                      <Link className="navigation__link navigation__link_type_profile navigation__link_type_profile-black hover-opacity-btn" to="/profile">
                        Аккаунт
                      </Link>
                    </div>
                  </nav>
